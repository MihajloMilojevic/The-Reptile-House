	...
	return (
		<div>
			<Head>
				...
				<meta
					name="description"
					content="Stranica sa svim terarijumima"
				/>
			</Head>
			...
			>
				...
				>
					<div style={{display: "inline", width: "auto"}}>
						...
						>
							<Link href={"/terarijumi/kreiraj"}><AiOutlinePlus color="white" size={40} /></Link>
						</GradientButton>
					</div>
				</Tooltip>
			</div>
			{ data && (
				data.length > 0 ?	
				<ProductList data={data} category="terarijumi" refresh={fetchData} /> :
				<PageTitle level={6} style={{fontSize: 24, marginTop: "5rem"}}>Nema terarijuma za prikaz</PageTitle>
			)}
		</div>
	)
}
